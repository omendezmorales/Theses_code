...
If Right(Wscript.Arguments(0),4) = ".msp" Then
	openMode = openMode + msiOpenDatabaseModePatchFile
End If

'Wscript.Echo "Open mode=" & openMode
...
For argNum = 1 To argCount - 1
	...
	End If
Next
If (openMode AND msiOpenDatabaseModeTransact) = msiOpenDatabaseModeTransact Then 
'	Wscript.Echo "Commiting databse"
	database.Commit
End If
